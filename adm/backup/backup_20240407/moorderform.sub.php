...
function calculate_tax()
{
  ...
  function pay_approval() {
    ...
    var rsvt_ts = pf.hp_rsvt_ts.value * 1000;
    var now_ts = +new Date();
    ...
    if (jQuery(pf).triggerHandler("form_sumbit_order_" + form_order_method) !== false) {
      <?php if ($default['de_pg_service'] == 'kcp') { ?>
        ...
        if (typeof pf.escrow_use !== "undefined") f.escrow_use.value = pf.escrow_use.value;
        ...
        if (settle_method == "간편결제") {
        ...
        } else if (settle_method == "해외카드") {
          if (typeof pf.goods_eng !== "undefined") f.goods_eng.value = pf.goods_eng.value;
          if (typeof pf.site_name_eng !== "undefined") f.site_name_eng.value = pf.site_name_eng.value;
          ...
          if (rsvt_ts == 0 || left_hour > 36) {
            ...
            f.ipgm_date.value = format_datetime(tomorrow, true)[0].replaceAll("-", "") + "235959";
          } else {
            f.ipgm_date.value = format_datetime(new Date(valid_ts)).replaceAll("-", "").replaceAll(":", "").replaceAll(" ", "");
          }
          
          console.log(f.ipgm_date.value);
