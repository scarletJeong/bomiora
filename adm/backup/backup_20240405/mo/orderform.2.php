...
<div id="display_pay_button" class="order_btn">
    <!-- //<input type="button" name="submitChecked" onClick="pay_approval" value="결제하기" class="page_list_btn"></span>-->
    <input type="button" name="submitChecked" id="make_payment_approval" value="결제하기" class="page_list_btn"></span>
    <!--<span id="show_pay_btn" style="display:none;"><input type="button" onClick="forderform_check();" value="주문하기" class="page_list_btn"></span>-->
    <span id="show_pay_btn" style="display:none;"><input type="button" id="make_payment" value="주문하기" class="page_list_btn"></span>
