...
$sql = " select po.*, mb.mb_name, mb.mb_nick, mb.mb_hp, mb.mb_email, mb.mb_homepage, mb.mb_point, hp.hp_rsvt_tel
            {$sql_common}
            LEFT JOIN {$g5['member_table']} mb ON po.mb_id = mb.mb_id
            LEFT JOIN {$g5['g5_shop_health_profile_cart_table']} hp ON po.mb_id = hp.mb_id
            {$sql_search}
            group by po.po_id
            {$sql_order}
            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr class="<?php echo $bg; ?>">
                        ...
                        <td class="td_center"><?php echo hyphen_hp_number($row['hp_rsvt_tel'] ? $row['hp_rsvt_tel'] : $row['mb_hp']); ?></td>
