...
// 인플루언서 회원 리스트
$inf_list  = '<option value="">선택</option>'.PHP_EOL;
...
for ($i=0; $row=sql_fetch_array($result); $i++) {
	$inf_list .= '<option value="'.$row['mb_id'].'">'.$row['mb_name'].'</option>'.PHP_EOL;
}
...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
        ...
        <td>
			...
			<select name="inf_mb_id" id="inf_mb_id">
				<?php echo conv_selected_option($inf_list, $is['mb_id']); ?>
			</select>
        </td>
    </tr>
