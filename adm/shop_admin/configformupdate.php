...
'de_bonus_point', //포인트 적립
'de_point_timing', // 포인트 적립 시기
'de_point_rate', // 포인트 적립 비율 (결제금액 대비)
'de_order_pack', // 주문통합
'de_pack_timing', // 통합 시 예약시간 기준
);
...
$sql = " update {$g5['g5_shop_default_table']}
            set de_admin_company_owner        = '{$de_admin_company_owner}',
                ...
                de_bonus_point                = '{$de_bonus_point}',
                de_point_timing               = '{$de_point_timing}',
                de_point_rate                 = '{$de_point_rate}',
                de_order_pack                 = '{$de_order_pack}',
                de_pack_timing                = '{$de_pack_timing}',
				...
				de_shipping_process_content   = '{$_POST['de_shipping_process_content']}',
				de_faq_content				  = '{$_POST['de_faq_content']}',
