...
if ($post_act_button == "선택수정") {
    ...
    for ($i=0; $i< $count_post_chk; $i++) {
		...
		$p_it_inf_price = (isset($_POST['it_inf_price']) && is_array($_POST['it_inf_price'])) ? strip_tags($_POST['it_inf_price'][$k]) : '';
        ...
        $sql = "update {$g5['g5_shop_item_table']}
                   set it_name        = '".$p_it_name."',
					   ...
					   it_inf_price = '".sql_real_escape_string($p_it_inf_price)."',
...
goto_url("./influencer_itemlist.php?sca=$sca&amp;sst=$sst&amp;sod=$sod&amp;sfl=$sfl&amp;stx=$stx&amp;page=$page");