...
if ($w == "")
{
	...
	$it_mb_inf	= explode(',', '');// 인플루언서 회원 아이디
}
else if ($w == "u")
{
    $html_title .= "수정";
	...
	$it_mb_inf = explode(',', $it['it_mb_inf']);// 추천과목
...
<li><a href="#anc_sitfrm_influencer">인플루언서설정</a></li>
</ul>
';
...
<section id="anc_sitfrm_influencer">
    <h2>인플루언서 설정</h2>
    <?php echo $pg_anchor ?>
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            ...
            <td>
                <input type="text" name="it_inf_price" value="<?php echo $it['it_inf_price']; ?>" id="it_inf_price" class="frm_input" size="8"> 원
            </td>
            <td class="td_grpset">
                <input type="checkbox" name="chk_ca_it_inf_price" value="1" id="chk_ca_it_inf_price">
                <label for="chk_ca_it_inf_price">분류적용</label>
                <input type="checkbox" name="chk_all_it_inf_price" value="1" id="chk_all_it_inf_price">
                <label for="chk_all_it_inf_price">전체적용</label>
            </td>
        </tr>
		<script>
		// 모두선택
		...
		<tr>
            ...
            <td>
				...
				?>
				<input type="checkbox" name="it_mb_inf[]" value="<?php echo $row['mb_id'] ?>" id="it_mb_inf_<?php echo $i ?>"<?php echo (in_array($row['mb_id'], $it_mb_inf) !== false) ? ' checked' : '' ?>>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_ca_it_mb_inf" value="1" id="chk_ca_it_mb_inf">
                <label for="chk_ca_it_mb_inf">분류적용</label>
                <input type="checkbox" name="chk_all_it_mb_inf" value="1" id="chk_all_it_mb_inf">
                <label for="chk_all_it_mb_inf">전체적용</label>
            </td>
        </tr>		
        <?php if ($w == "u") { ?>
        <tr>
