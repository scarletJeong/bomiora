...
<form name="fitemform" action="./influencer_itemformupdate.php" method="post" enctype="MULTIPART/FORM-DATA" autocomplete="off" onsubmit="return fitemformcheck(this)">
...
<section id="anc_sitfrm_ini">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <?php } else { ?>
                    ...
                    <a href="<?php echo G5_ADMIN_URL; ?>/shop_admin/itemuselist.php?sfl=a.it_id&amp;stx=<?php echo $it['it_org_id']; ?>" class="btn_frmline">사용후기</a>
                <?php } ?>
            </td>
        </tr>
		<!-- 추가 : psk8125 -->
        ...
        <tr>
            ...
            <td colspan="2"><textarea name="it_shop_memo" id="it_shop_memo"><?php echo html_purifier($it['it_shop_memo']); ?></textarea></td>
			<!--
            <td class="td_grpset">
