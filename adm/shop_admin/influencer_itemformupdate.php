...
if ($w == "u") {
    goto_url("./influencer_itemform.php?w=u&amp;it_id=$it_id&amp;$qstr");
} else if ($w == "d")  {
    $qstr = "ca_id=$ca_id&amp;sfl=$sfl&amp;sca=$sca&amp;page=$page&amp;stx=".urlencode($stx)."&amp;save_stx=".urlencode($save_stx);
    goto_url("./influencer_itemlist.php?$qstr");
}
...
<script>
    if (confirm("계속 입력하시겠습니까?"))
        location.href = "<?php echo "./influencer_itemform.php?".str_replace('&amp;', '&', $qstr); ?>";
    else
        location.href = "<?php echo "./influencer_itemform.php?".str_replace('&amp;', '&', $qstr); ?>";
</script>
