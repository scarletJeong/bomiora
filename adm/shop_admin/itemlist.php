...
$sql_common = " from {$g5['g5_shop_item_table']} a ,
               ...
               where (a.ca_id = b.ca_id and b.ca_id <> '40' ";
if ($is_admin != 'super')
...
<select name="sca" id="sca">
    ...
    <?php
    $sql1 = " select ca_id, ca_name from {$g5['g5_shop_category_table']} where ca_id <> '40' order by ca_order, ca_id ";
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td rowspan="3" class="td_mng td_mng_s">
            ...
            <a href="./iteminfcopy.php?it_id=<?php echo $row['it_id']; ?>&amp;ca_id=<?php echo $row['ca_id']; ?>" class="iteminfcopy btn btn_02" target="_blank"><span class="sound_only"><?php echo htmlspecialchars2(cut_str($row['it_name'],250, "")); ?> </span>분배</a>
...
$(function() {
    $(".iteminfcopy").click(function() {
        var href = $(this).attr("href");
        window.open(href, "copywin", "left=100, top=100, width=800, height=500, scrollbars=0");
        return false;
    });
});
