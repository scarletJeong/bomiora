...
$menu['menu400'] = array(
    ...
    array('400910', '주문내역2', G5_ADMIN_URL . '/shop_admin/orderlist2.php', 'scf_adjustment', 1),            
    array('400900', '정산관리', G5_ADMIN_URL . '/shop_admin/settlement.php', 'scf_adjustment', 1),        
    ...
    array('400650', '리뷰관리', G5_ADMIN_URL . '/shop_admin/itemuselist.php', 'scf_ps'),
