...
<?php
// 상품수
//$sql = " select count(*) as cnt from {$g5['g5_shop_item_table']} where it_mb_inf in ('{$mb_id}') and it_use = '1' ";
$sql = " select count(*) as cnt from {$g5['g5_shop_item_table']} where LOCATE('{$mb_id}', it_mb_inf) > 0 and it_use = '1' "; 
$row = sql_fetch($sql);
$item_count = $row['cnt'];
$sql = " select * from {$g5['g5_shop_item_table']} where  LOCATE('{$mb_id}', it_mb_inf) > 0 and it_use = '1' order by it_id desc ";
                ...
                ?>
                    ...
                    <tr class="<?php echo $bg; ?>">
                        ...
                        <td class="td_mng">
							...
							<input type="hidden" name="itemurl" value="<?php echo $href ?>&infcode=<?php echo $mb['mb_inf_code'] ?>" id="itemurl_<?php echo $i ?>">
						</td>
                    </tr>
                <?php
                }
