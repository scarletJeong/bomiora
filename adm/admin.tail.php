...
<script>
    ...
    //background popup jacknam
    $(document).on("click", "#popup_section .modal_bg", function(e) {
      e.preventDefault();
      //e.stopPropagation();
      var _this = $(this);
      if (_this.hasClass("modal_msg")) {
        _this.remove().end();
      } else {
        _this.find(".modal_box").empty().end();
        _this.removeClass("on");
      }
      return false;
    });

    $(document).on("click", "#popup_section .modal_bg .modal_box", function(e) {
      e.preventDefault();
      return false;
    });
    //background popup jacknam
