...
$sql_common = " from {$g5['g5_shop_health_profile_cart_table']} where hp_status <> '쇼핑' and hp_output = 'Y' ";
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
		...
		<td><?php echo stripslashes($row2['it_name']); ?><br><?php echo $row2['od_id'] ?></td>		 
			...
			<div class="diagnosis_main">
				<div>
					...
					<div class="diagnosis_main_list">
						...
						?>
						<span class="requisite"><?php echo get_text($opt['ct_option']); ?></span>
						<?php } ?>
